...
![Buka file src/pages/404.tsx](docs/praktikum-018/langkah-1a.png)

*Buka file src/pages/404.tsx*

![Modifikasi kode pada file src/pages/404.tsx](docs/praktikum-018/langkah-1b.png)

*Modifikasi kode pada file src/pages/404.tsx*

### 2. Optimasi Gambar Remote (External URL)

![Buka file src/pages/404.tsx](docs/praktikum-018/langkah-2a.png)

*Buka file src/pages/404.tsx*

![Modifikasi kode pada file src/pages/404.tsx](docs/praktikum-018/langkah-2b.png)

*Modifikasi kode pada file src/pages/404.tsx*

### 3. Menggunakan next/font

![Buka file src/components/layouts/AppShell/index.tsx](docs/praktikum-018/langkah-3a.png)

*Buka file src/components/layouts/AppShell/index.tsx*

![Hasil inspect font](docs/praktikum-018/langkah-3b.png)

*Hasil inspect font*

### 4. Menggunakan next/script

![Modifikasi file src/components/layouts/navbar/index.tsx](docs/praktikum-018/langkah-4a.png)

*Modifikasi file src/components/layouts/navbar/index.tsx*

### 5. Optimasi Avatar dengan next/image

![Modifikasi file src/components/layouts/navbar/index.tsx](docs/praktikum-018/langkah-5a.png)

*Modifikasi file src/components/layouts/navbar/index.tsx*

![Modifikasi file next.config.js](docs/praktikum-018/langkah-5b.png)
...
![Optimasi semua image di project](docs/praktikum-018/tugas-1a.png)

*Optimasi semua image di project*

### 2. Gunakan minimal 1 font dari next/font

![Menggunakan font roboto di app shell](docs/praktikum-018/tugas-2a.png)

*Menggunakan font roboto di app shell*

### 3. Tambahkan script Google Analytics menggunakan next/script

![Menambahkan script google analytics](docs/praktikum-018/tugas-3a.png)

*Menambahkan script google analytics*

### 4. Terapkan dynamic import pada minimal 1 komponen

![Terapkan dynamic import pada navbar](docs/praktikum-018/tugas-4a.png)

*Terapkan dynamic import pada navbar*

### 5. Dokumentasikan perubahan performa (screenshot Lighthouse)

![Dokumentasi lighthouse http://localhost:3000/produk](docs/praktikum-018/tugas-5a.png)
