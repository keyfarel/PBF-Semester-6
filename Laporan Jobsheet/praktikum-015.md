...
![Buka views/auth/register](docs/praktikum-015/langkah-1a.png)

*Buka views/auth/register*

![Modifikasi views/auth/register/index.tsx](docs/praktikum-015/langkah-1b.png)

*Modifikasi views/auth/register/index.tsx*

![Modifikasi views/auth/register/register.module.scss](docs/praktikum-015/langkah-1c.png)

*Modifikasi views/auth/register/register.module.scss*

![Tampilan Halaman Register](docs/praktikum-015/langkah-1d.png)

*Tampilan Halaman Register*

### 2. Membuat API Register

![menambah dan memodifikasi pages/api/register.ts](docs/praktikum-015/langkah-2a.png)

*menambah dan memodifikasi pages/api/register.ts*

![Modifikasi utils/db/servicefirebase.ts](docs/praktikum-015/langkah-2b.png)

*Modifikasi utils/db/servicefirebase.ts*

![Modifikasi views/auth/register/index.tsx](docs/praktikum-015/langkah-2c.png)

*Modifikasi views/auth/register/index.tsx*

![Mengisi form register](docs/praktikum-015/langkah-2d.png)

*Mengisi form register*

![Register berhasil dan mengarah ke halaman login](docs/praktikum-015/langkah-2e.png)

*Register berhasil dan mengarah ke halaman login*

### 3. Install bcrypt

![install bcrypt](docs/praktikum-015/langkah-3a.png)

*install bcrypt*

![Modifikasi utils/db/servicefirebase.ts](docs/praktikum-015/langkah-3b.png)

*Modifikasi utils/db/servicefirebase.ts*

![Modifikasi views/auth/register/register.module.scss](docs/praktikum-015/langkah-3c1.png)
![Modifikasi views/auth/register/register.module.scss](docs/praktikum-015/langkah-3c2.png)

*Modifikasi views/auth/register/register.module.scss*

![Test register dengan akun belum terdaftar](docs/praktikum-015/langkah-3d.png)

*Test register dengan akun belum terdaftar*

![Proses registrasi ditandai dengan loading](docs/praktikum-015/langkah-3e.png)

*Proses registrasi ditandai dengan loading*

![Register berhasil dan mengarah ke login page](docs/praktikum-015/langkah-3f.png)

*Register berhasil dan mengarah ke login page*

![Register gagal karena akun sudah terdaftar](docs/praktikum-015/langkah-3g.png)

*Register gagal karena akun sudah terdaftar*

![Data yang tersimpan di firestore](docs/praktikum-015/langkah-3h.png)
...
![Method GET not allowed](docs/praktikum-015/uji-3.png)
