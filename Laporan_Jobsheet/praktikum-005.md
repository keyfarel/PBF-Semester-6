...
![global.css Code](docs/praktikum-005/langkah-1a.png)
*global.css Code*

![_app.tsx Code](docs/praktikum-005/langkah-1b.png)
*_app.tsx Code*

### 2. CSS Module (Local Scope)

![Navbar Folder](docs/praktikum-005/langkah-2a.png)
*Navbar Folder*

![global.css Code Update](docs/praktikum-005/langkah-2b.png)
*global.css Code Update*

![navbar.module.css Code](docs/praktikum-005/langkah-2c.png)
*navbar.module.css Code*

![navbar.tsx Code](docs/praktikum-005/langkah-2d.png)
*navbar.tsx Code*

![Navbar UI](docs/praktikum-005/langkah-2e.png)
*Navbar UI*

### 3. Styling untuk Pages (CSS Module)

![Login Folder](docs/praktikum-005/langkah-3a.png)
*Login Folder*

![login.module.css Code](docs/praktikum-005/langkah-3b.png)
*login.module.css Code*

![login.tsx Code](docs/praktikum-005/langkah-3c.png)
*login.tsx Code*

![Login Code Update](docs/praktikum-005/langkah-3d.png)
*Login Code Update*

### 4. Styling untuk Components (CSS Module)

![App Shell Code](docs/praktikum-005/langkah-4a.png)
*App Shell Code*

![Login UI](docs/praktikum-005/langkah-4b.png)
*Login UI*

![App Shell Update](docs/praktikum-005/langkah-4c.png)
*App Shell Update*

![Login Console](docs/praktikum-005/langkah-4d.png)
*Login Console*

### 5. Refactoring Struktur Project (Best Practice)

![Login Folder](docs/praktikum-005/langkah-5a.png)
*Login Folder*

![Navbar Folder Update Views](docs/praktikum-005/langkah-5b.png)
*Navbar Folder Update Views*

![Login Css Module Update](docs/praktikum-005/langkah-5c.png)
*Login Css Module Update*

![Login Code Update](docs/praktikum-005/langkah-5d.png)
*Login Code Update*

![Login Code Views Update](docs/praktikum-005/langkah-5e.png)
*Login Code Views Update*

![Login UI](docs/praktikum-005/langkah-5f.png)
*Login UI*

### 6. Inline Styling (CSS-in-JS)

![Login Inline Styling](docs/praktikum-005/langkah-6a.png)
*Login Inline Styling*

![Login UI Update](docs/praktikum-005/langkah-6b.png)
*Login UI Update*

### 7. Kombinasi Global CSS + CSS Module

![Global CSS Update](docs/praktikum-005/langkah-7a.png)
*Global CSS Update*

![Update Navbar](docs/praktikum-005/langkah-7b.png)
*Update Navbar*

### 8. SCSS (SASS)

![package.json Update add sass](docs/praktikum-005/langkah-8a.png)
*package.json Update add sass*

![add color.scss](docs/praktikum-005/langkah-8b.png)
*add color.scss*

![add schema code](docs/praktikum-005/langkah-8c.png)
*add schema code*

![add login module scss](docs/praktikum-005/langkah-8d.png)
*add login module scss*

![login code update](docs/praktikum-005/langkah-8e.png)
*login code update*

![import color.scss](docs/praktikum-005/langkah-8f.png)
*import color.scss*

![login ui update](docs/praktikum-005/langkah-8g.png)
*login ui update*

### 9. Tailwind CSS

![install tailwind](docs/praktikum-005/langkah-9a.png)
*install tailwind*

![config tailwind](docs/praktikum-005/langkah-9b.png)
*config tailwind*

![import tailwind](docs/praktikum-005/langkah-9c.png)
*import tailwind*

![login code update](docs/praktikum-005/langkah-9d.png)
*login code update*

![login ui update](docs/praktikum-005/langkah-9e.png)
*login ui update*
...
![register view code](docs/praktikum-005/tugas-1a.png)
*register view code*

![register pages code update](docs/praktikum-005/tugas-1b.png)
*register pages code update*

![register scss module update](docs/praktikum-005/tugas-1c.png)
*register scss module update*

![register ui update](docs/praktikum-005/tugas-1d.png)
*register ui update*

### Tugas 2

![product pages folder](docs/praktikum-005/tugas-2a.png)
*product pages folder*

![product pages code update](docs/praktikum-005/tugas-2b.png)
*product pages code update*

![product pages hero section update](docs/praktikum-005/tugas-2c.png)
*product pages hero section update*

![product pages ui update](docs/praktikum-005/tugas-2d.png)
*product pages ui update*

### Tugas 3

![product pages hero section update](docs/praktikum-005/tugas-3a.png)
*product pages hero section update*

![product pages index update](docs/praktikum-005/tugas-3b.png)
*product pages index update*

![product pages hero section update](docs/praktikum-005/tugas-3c.png)
*product pages hero section update*

![product pages ui update](docs/praktikum-005/tugas-3d.png)
*product pages ui update*
